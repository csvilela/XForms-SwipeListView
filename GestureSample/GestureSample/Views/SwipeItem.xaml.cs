...
namespace GestureSample.Views
{
    public partial class SwipeItem : ContentView
    {
        ...
        private double ClosingPoint => this.MainContentGrid.Width * ActionItemSize * -1;

        private double PartialSwipePoint => this.ActionItemsLayout.Children.Sum(item => item.WidthRequest) * -1;
